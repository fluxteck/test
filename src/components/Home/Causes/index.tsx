    ...
    <section className="lg:py-28 py-16 bg-grey dark:bg-darkmode">
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
        ...
        <p className="text-base text-muted dark:text-white/60 text-center">
          We focus on essential causes like education, hunger relief,
          healthcare, and community empowerment.{" "}
          <br className="lg:block hidden" /> With your support, we can create
          lasting change.
        </p>
        <div className="mt-20">
          <Slider {...settings}>
            {CauseData.slice(0, 3).map((item, index) => (
              ...
              <Link href="#" key={index} className="px-4">
                <div
