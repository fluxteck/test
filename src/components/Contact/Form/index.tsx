        ...
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4">
          <div className="grid lg:grid-cols-12 grid-cols-1 gap-8">
            <div className="lg:col-span-6 lg:order-1 order-2">
              <h2 className="text-[40px] leading-tight font-bold mb-9 text-midnight_text dark:text-white">
              ...
              <form className="flex flex-wrap w-full m-auto justify-between">
                ...
                <div className="sm:flex gap-3 w-full">
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    ...
                    >
                      ...
                      <option value="Exotic Cuisine">Education</option>
                      <option value="French Desserts">Food</option>
                      <option value="Seafood &amp; Wine">Medicals</option>
                    </select>
                  </div>
                </div>
                <div className="sm:flex gap-3 w-full">
                ...
                <div className="mx-0 my-2.5 w-full">
                  <Link
                    href="https://wa.me/917678017569?text=Hello%20Dilkhush%20Foundation%2C%20I%27d%20like%20to%20connect%20regarding%20donation%20or%20volunteering."
                    target="_blank"
